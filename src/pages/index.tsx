  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of tool rental with Construction Tool Rental - Your central supplier with multiple outlets, enabling individual customers to rent construction tools effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMkJ0b29sc3xlbnwwfHx8fDE2OTg2NTIzNzB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of tool rental with Construction Tool Rental - Your central supplier with multiple outlets, enabling individual customers to rent construction tools effortlessly.`}
            </Text>
            <Box
